  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        caption_label:
          'text-base xl:text-xl text-left font-poppins font-medium w-full',
        ...
        head_row: 'flex',
        head_cell:
          'text-lightHeading dark:text-calendarScheduleText rounded-md w-6 xl:w-8 font-poppins font-medium text-sm md:text-xs uppercase',
        ...
        day: cn(
          ...
          'w-6 h-6 xl:h-8 xl:w-8 p-0 font-medium font-poppins aria-selected:opacity-100 hover:rounded-full hover:bg-[#FFFFFF1A] text-xs flex items-center justify-center'
        ),
        day_range_start: 'day-range-start',
        day_range_end: 'day-range-end',
        day_selected: 'text-[#FF5F5F]',
